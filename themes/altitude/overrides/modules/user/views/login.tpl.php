<section class="user-auth-page altitude-user-auth">
	<div class="user-auth-box">
		...
		<div class="user-auth-form"><?php echo $form ?></div>
		...
		<div class="user-auth-providers">
			...
			<a href="<?php echo url('user/auth/'.url_title($authenticator->info()->name)) ?>">
